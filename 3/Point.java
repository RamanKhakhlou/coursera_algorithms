...
public class Point implements Comparable<Point> {
    ...
    public Point(int x, int y) {
        /* DO NOT MODIFY */
        if (x < 0 || x > 32767) throw new Error("Invalid x value");
        if (y < 0 || y > 32767) throw new Error("Invalid y value");
        this.x = x;
        this.y = y;
    }
    ...
    public static void main(String[] args) {
        /* YOUR CODE HERE */
        Point p = new Point(252, 349);
        Point q = new Point(136, 323);
